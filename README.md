...
As of May 2026, I am nearing the end of my second year as a Ph.D. student at UT Dallas. Over the winter break, I developed a framework for formally verifying the correctness of code under the presence of hardware faults, [and published it in NDSS BAR](https://www.ndss-symposium.org/wp-content/uploads/bar2026-46.pdf). I finished a bunch of OCaml applications, like [an image file viewer](https://github.com/CharlesAverill/scope), [bindings to file dialog APIs](https://github.com/CharlesAverill/tinyfiledialogs), [an RNG suite that compiles to WASM](https://github.com/CharlesAverill/rng), [a distributed file-sharing protocol](https://github.com/CharlesAverill/p2pml), [a spacecraft trajectory viewer](https://github.com/CharlesAverill/ephemeral), and an in-progress [implementation of L* for detecting firewall vulnerabilities using NetKAT](https://github.com/CharlesAverill/snka-learning). Going back in time, I developed a [slideshow presentation engine](https://github.com/CharlesAverill/presenter99) for the TI-99/4a home computer. I will soon present my qualifying exam, a [survey paper](https://charles.systems/writings/qe.pdf) on [AI proof automation techniques](https://charles.systems/qe). Also over the winter break, I did quite a bit of game-related development, including [a homebrew NES asteroids game](https://github.com/CharlesAverill/RedShift), [a Caml interpreter for the Nintendo 3DS](https://github.com/CharlesAverill/SuperML), [a native 3DS port of Super Metroid](https://github.com/CharlesAverill/sm-3ds), and [some decompilation work for Metroid Fusion](https://github.com/CharlesAverill/mf). I'm currently working on a few research projects, including [a formally-verified implementation of the L* algorithm in Rocq](https://github.com/CharlesAverill/lstar-rocq) and [a Rocq formalization of Incorrectness and Adversarial Logic](https://github.com/CharlesAverill/ILAL).
...
![Charles's GitHub stats](https://github-stats-extended.vercel.app/api?username=CharlesAverill&rank_icon=github&theme=neon&show_icons=true&show=reviews,discussions_started,discussions_answered,prs_merged,prs_merged_percentage) 
